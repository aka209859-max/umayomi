var Re=Object.defineProperty;var zt=e=>{throw TypeError(e)};var _e=(e,t,s)=>t in e?Re(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var g=(e,t,s)=>_e(e,typeof t!="symbol"?t+"":t,s),Ht=(e,t,s)=>t.has(e)||zt("Cannot "+s);var o=(e,t,s)=>(Ht(e,t,"read from private field"),s?s.call(e):t.get(e)),v=(e,t,s)=>t.has(e)?zt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),m=(e,t,s,r)=>(Ht(e,t,"write to private field"),r?r.call(e,s):t.set(e,s),s),b=(e,t,s)=>(Ht(e,t,"access private method"),s);var Wt=(e,t,s,r)=>({set _(a){m(e,t,a,s)},get _(){return o(e,t,r)}});var Gt=(e,t,s)=>(r,a)=>{let n=-1;return i(0);async function i(d){if(d<=n)throw new Error("next() called multiple times");n=d;let l,c=!1,u;if(e[d]?(u=e[d][0][0],r.req.routeIndex=d):u=d===e.length&&a||void 0,u)try{l=await u(r,()=>i(d+1))}catch(f){if(f instanceof Error&&t)r.error=f,l=await t(f,r),c=!0;else throw f}else r.finalized===!1&&s&&(l=await s(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},Se=Symbol(),Me=async(e,t=Object.create(null))=>{const{all:s=!1,dot:r=!1}=t,n=(e instanceof de?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Ie(e,{all:s,dot:r}):{}};async function Ie(e,t){const s=await e.formData();return s?$e(s,t):{}}function $e(e,t){const s=Object.create(null);return e.forEach((r,a)=>{t.all||a.endsWith("[]")?Oe(s,a,r):s[a]=r}),t.dot&&Object.entries(s).forEach(([r,a])=>{r.includes(".")&&(Ae(s,r,a),delete s[r])}),s}var Oe=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Ae=(e,t,s)=>{let r=e;const a=t.split(".");a.forEach((n,i)=>{i===a.length-1?r[n]=s:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},ne=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Te=e=>{const{groups:t,path:s}=Fe(e),r=ne(s);return Pe(r,t)},Fe=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,r)=>{const a=`@${r}`;return t.push([a,s]),a}),{groups:t,path:e}},Pe=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[r]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(r)){e[a]=e[a].replace(r,t[s][1]);break}}return e},It={},De=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const r=`${e}#${t}`;return It[r]||(s[2]?It[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:It[r]=[e,s[1],!0]),It[r]}return null},Ut=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},Be=e=>Ut(e,decodeURI),ie=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let r=s;for(;r<t.length;r++){const a=t.charCodeAt(r);if(a===37){const n=t.indexOf("?",r),i=t.slice(s,n===-1?void 0:n);return Be(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(a===63)break}return t.slice(s,r)},He=e=>{const t=ie(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},nt=(e,t,...s)=>(s.length&&(t=nt(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),oe=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let r="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))r+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&r===""?s.push("/"):s.push(r);const n=a.replace("?","");r+="/"+n,s.push(r)}else r+="/"+a}),s.filter((a,n,i)=>i.indexOf(a)===n)},Nt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ut(e,le):e):e,ce=(e,t,s)=>{let r;if(!s&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const d=e.charCodeAt(i+t.length+1);if(d===61){const l=i+t.length+2,c=e.indexOf("&",l);return Nt(e.slice(l,c===-1?void 0:c))}else if(d==38||isNaN(d))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const a={};r??(r=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const i=e.indexOf("&",n+1);let d=e.indexOf("=",n);d>i&&i!==-1&&(d=-1);let l=e.slice(n+1,d===-1?i===-1?void 0:i:d);if(r&&(l=Nt(l)),n=i,l==="")continue;let c;d===-1?c="":(c=e.slice(d+1,i===-1?void 0:i),r&&(c=Nt(c))),s?(a[l]&&Array.isArray(a[l])||(a[l]=[]),a[l].push(c)):a[l]??(a[l]=c)}return t?a[t]:a},Ne=ce,Le=(e,t)=>ce(e,t,!0),le=decodeURIComponent,Yt=e=>Ut(e,le),ct,I,H,ue,fe,qt,L,Zt,de=(Zt=class{constructor(e,t="/",s=[[]]){v(this,H);g(this,"raw");v(this,ct);v(this,I);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});v(this,L,e=>{const{bodyCache:t,raw:s}=this,r=t[e];if(r)return r;const a=Object.keys(t)[0];return a?t[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,m(this,I,s),m(this,ct,{})}param(e){return e?b(this,H,ue).call(this,e):b(this,H,fe).call(this)}query(e){return Ne(this.url,e)}queries(e){return Le(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,r)=>{t[r]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Me(this,e))}json(){return o(this,L).call(this,"text").then(e=>JSON.parse(e))}text(){return o(this,L).call(this,"text")}arrayBuffer(){return o(this,L).call(this,"arrayBuffer")}blob(){return o(this,L).call(this,"blob")}formData(){return o(this,L).call(this,"formData")}addValidatedData(e,t){o(this,ct)[e]=t}valid(e){return o(this,ct)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Se](){return o(this,I)}get matchedRoutes(){return o(this,I)[0].map(([[,e]])=>e)}get routePath(){return o(this,I)[0].map(([[,e]])=>e)[this.routeIndex].path}},ct=new WeakMap,I=new WeakMap,H=new WeakSet,ue=function(e){const t=o(this,I)[0][this.routeIndex][1][e],s=b(this,H,qt).call(this,t);return s&&/\%/.test(s)?Yt(s):s},fe=function(){const e={},t=Object.keys(o(this,I)[0][this.routeIndex][1]);for(const s of t){const r=b(this,H,qt).call(this,o(this,I)[0][this.routeIndex][1][s]);r!==void 0&&(e[s]=/\%/.test(r)?Yt(r):r)}return e},qt=function(e){return o(this,I)[1]?o(this,I)[1][e]:e},L=new WeakMap,Zt),qe={Stringify:1},pe=async(e,t,s,r,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(d=>d({phase:t,buffer:a,context:r}))).then(d=>Promise.all(d.filter(Boolean).map(l=>pe(l,t,!1,r,a))).then(()=>a[0]))):Promise.resolve(e)},Ue="text/plain; charset=UTF-8",Lt=(e,t)=>({"Content-Type":e,...t}),jt,kt,F,lt,P,_,Et,dt,ut,X,Rt,_t,q,it,te,ze=(te=class{constructor(e,t){v(this,q);v(this,jt);v(this,kt);g(this,"env",{});v(this,F);g(this,"finalized",!1);g(this,"error");v(this,lt);v(this,P);v(this,_);v(this,Et);v(this,dt);v(this,ut);v(this,X);v(this,Rt);v(this,_t);g(this,"render",(...e)=>(o(this,dt)??m(this,dt,t=>this.html(t)),o(this,dt).call(this,...e)));g(this,"setLayout",e=>m(this,Et,e));g(this,"getLayout",()=>o(this,Et));g(this,"setRenderer",e=>{m(this,dt,e)});g(this,"header",(e,t,s)=>{this.finalized&&m(this,_,new Response(o(this,_).body,o(this,_)));const r=o(this,_)?o(this,_).headers:o(this,X)??m(this,X,new Headers);t===void 0?r.delete(e):s!=null&&s.append?r.append(e,t):r.set(e,t)});g(this,"status",e=>{m(this,lt,e)});g(this,"set",(e,t)=>{o(this,F)??m(this,F,new Map),o(this,F).set(e,t)});g(this,"get",e=>o(this,F)?o(this,F).get(e):void 0);g(this,"newResponse",(...e)=>b(this,q,it).call(this,...e));g(this,"body",(e,t,s)=>b(this,q,it).call(this,e,t,s));g(this,"text",(e,t,s)=>!o(this,X)&&!o(this,lt)&&!t&&!s&&!this.finalized?new Response(e):b(this,q,it).call(this,e,t,Lt(Ue,s)));g(this,"json",(e,t,s)=>b(this,q,it).call(this,JSON.stringify(e),t,Lt("application/json",s)));g(this,"html",(e,t,s)=>{const r=a=>b(this,q,it).call(this,a,t,Lt("text/html; charset=UTF-8",s));return typeof e=="object"?pe(e,qe.Stringify,!1,{}).then(r):r(e)});g(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});g(this,"notFound",()=>(o(this,ut)??m(this,ut,()=>new Response),o(this,ut).call(this,this)));m(this,jt,e),t&&(m(this,P,t.executionCtx),this.env=t.env,m(this,ut,t.notFoundHandler),m(this,_t,t.path),m(this,Rt,t.matchResult))}get req(){return o(this,kt)??m(this,kt,new de(o(this,jt),o(this,_t),o(this,Rt))),o(this,kt)}get event(){if(o(this,P)&&"respondWith"in o(this,P))return o(this,P);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,P))return o(this,P);throw Error("This context has no ExecutionContext")}get res(){return o(this,_)||m(this,_,new Response(null,{headers:o(this,X)??m(this,X,new Headers)}))}set res(e){if(o(this,_)&&e){e=new Response(e.body,e);for(const[t,s]of o(this,_).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=o(this,_).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of r)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}m(this,_,e),this.finalized=!0}get var(){return o(this,F)?Object.fromEntries(o(this,F)):{}}},jt=new WeakMap,kt=new WeakMap,F=new WeakMap,lt=new WeakMap,P=new WeakMap,_=new WeakMap,Et=new WeakMap,dt=new WeakMap,ut=new WeakMap,X=new WeakMap,Rt=new WeakMap,_t=new WeakMap,q=new WeakSet,it=function(e,t,s){const r=o(this,_)?new Headers(o(this,_).headers):o(this,X)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,d]of n)i.toLowerCase()==="set-cookie"?r.append(i,d):r.set(i,d)}if(s)for(const[n,i]of Object.entries(s))if(typeof i=="string")r.set(n,i);else{r.delete(n);for(const d of i)r.append(n,d)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,lt);return new Response(e,{status:a,headers:r})},te),j="ALL",We="all",Ge=["get","post","put","delete","options","patch"],he="Can not add a route since the matcher is already built.",me=class extends Error{},Ye="__COMPOSED_HANDLER",Ve=e=>e.text("404 Not Found",404),Vt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},$,k,ge,O,J,$t,Ot,ft,Je=(ft=class{constructor(t={}){v(this,k);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");v(this,$,"/");g(this,"routes",[]);v(this,O,Ve);g(this,"errorHandler",Vt);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(m(this,O,t),this));g(this,"fetch",(t,...s)=>b(this,k,Ot).call(this,t,s[1],s[0],t.method));g(this,"request",(t,s,r,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,r,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${nt("/",t)}`,s),r,a)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,k,Ot).call(this,t.request,t,void 0,t.request.method))})});[...Ge,We].forEach(n=>{this[n]=(i,...d)=>(typeof i=="string"?m(this,$,i):b(this,k,J).call(this,n,o(this,$),i),d.forEach(l=>{b(this,k,J).call(this,n,o(this,$),l)}),this)}),this.on=(n,i,...d)=>{for(const l of[i].flat()){m(this,$,l);for(const c of[n].flat())d.map(u=>{b(this,k,J).call(this,c.toUpperCase(),o(this,$),u)})}return this},this.use=(n,...i)=>(typeof n=="string"?m(this,$,n):(m(this,$,"*"),i.unshift(n)),i.forEach(d=>{b(this,k,J).call(this,j,o(this,$),d)}),this);const{strict:r,...a}=t;Object.assign(this,a),this.getPath=r??!0?t.getPath??ie:He}route(t,s){const r=this.basePath(t);return s.routes.map(a=>{var i;let n;s.errorHandler===Vt?n=a.handler:(n=async(d,l)=>(await Gt([],s.errorHandler)(d,()=>a.handler(d,l))).res,n[Ye]=a.handler),b(i=r,k,J).call(i,a.method,a.path,n)}),this}basePath(t){const s=b(this,k,ge).call(this);return s._basePath=nt(this._basePath,t),s}mount(t,s,r){let a,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?a=l=>l:a=r.replaceRequest));const i=n?l=>{const c=n(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};a||(a=(()=>{const l=nt(this._basePath,t),c=l==="/"?0:l.length;return u=>{const f=new URL(u.url);return f.pathname=f.pathname.slice(c)||"/",new Request(f,u)}})());const d=async(l,c)=>{const u=await s(a(l.req.raw),...i(l));if(u)return u;await c()};return b(this,k,J).call(this,j,nt(t,"*"),d),this}},$=new WeakMap,k=new WeakSet,ge=function(){const t=new ft({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,O,o(this,O)),t.routes=this.routes,t},O=new WeakMap,J=function(t,s,r){t=t.toUpperCase(),s=nt(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:r};this.router.add(t,s,[r,a]),this.routes.push(a)},$t=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Ot=function(t,s,r,a){if(a==="HEAD")return(async()=>new Response(null,await b(this,k,Ot).call(this,t,s,r,"GET")))();const n=this.getPath(t,{env:r}),i=this.router.match(a,n),d=new ze(t,{path:n,matchResult:i,env:r,executionCtx:s,notFoundHandler:o(this,O)});if(i[0].length===1){let c;try{c=i[0][0][0][0](d,async()=>{d.res=await o(this,O).call(this,d)})}catch(u){return b(this,k,$t).call(this,u,d)}return c instanceof Promise?c.then(u=>u||(d.finalized?d.res:o(this,O).call(this,d))).catch(u=>b(this,k,$t).call(this,u,d)):c??o(this,O).call(this,d)}const l=Gt(i[0],this.errorHandler,o(this,O));return(async()=>{try{const c=await l(d);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return b(this,k,$t).call(this,c,d)}})()},ft),xe=[];function Ke(e,t){const s=this.buildAllMatchers(),r=(a,n)=>{const i=s[a]||s[j],d=i[2][n];if(d)return d;const l=n.match(i[0]);if(!l)return[[],xe];const c=l.indexOf("",1);return[i[1][c],l]};return this.match=r,r(e,t)}var Tt="[^/]+",yt=".*",wt="(?:|/.*)",ot=Symbol(),Xe=new Set(".\\+*[^]$()");function Qe(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===yt||e===wt?1:t===yt||t===wt?-1:e===Tt?1:t===Tt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Q,Z,A,st,Ze=(st=class{constructor(){v(this,Q);v(this,Z);v(this,A,Object.create(null))}insert(t,s,r,a,n){if(t.length===0){if(o(this,Q)!==void 0)throw ot;if(n)return;m(this,Q,s);return}const[i,...d]=t,l=i==="*"?d.length===0?["","",yt]:["","",Tt]:i==="/*"?["","",wt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let f=l[2]||Tt;if(u&&l[2]&&(f===".*"||(f=f.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(f))))throw ot;if(c=o(this,A)[f],!c){if(Object.keys(o(this,A)).some(p=>p!==yt&&p!==wt))throw ot;if(n)return;c=o(this,A)[f]=new st,u!==""&&m(c,Z,a.varIndex++)}!n&&u!==""&&r.push([u,o(c,Z)])}else if(c=o(this,A)[i],!c){if(Object.keys(o(this,A)).some(u=>u.length>1&&u!==yt&&u!==wt))throw ot;if(n)return;c=o(this,A)[i]=new st}c.insert(d,s,r,a,n)}buildRegExpStr(){const s=Object.keys(o(this,A)).sort(Qe).map(r=>{const a=o(this,A)[r];return(typeof o(a,Z)=="number"?`(${r})@${o(a,Z)}`:Xe.has(r)?`\\${r}`:r)+a.buildRegExpStr()});return typeof o(this,Q)=="number"&&s.unshift(`#${o(this,Q)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Q=new WeakMap,Z=new WeakMap,A=new WeakMap,st),Ft,St,ee,ts=(ee=class{constructor(){v(this,Ft,{varIndex:0});v(this,St,new Ze)}insert(e,t,s){const r=[],a=[];for(let i=0;;){let d=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return a[i]=[c,l],i++,d=!0,c}),!d)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=a.length-1;i>=0;i--){const[d]=a[i];for(let l=n.length-1;l>=0;l--)if(n[l].indexOf(d)!==-1){n[l]=n[l].replace(d,a[i][1]);break}}return o(this,St).insert(n,t,r,o(this,Ft),s),r}buildRegExp(){let e=o(this,St).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,i)=>n!==void 0?(s[++t]=Number(n),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),s,r]}},Ft=new WeakMap,St=new WeakMap,ee),es=[/^$/,[],Object.create(null)],At=Object.create(null);function ve(e){return At[e]??(At[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ss(){At=Object.create(null)}function rs(e){var c;const t=new ts,s=[];if(e.length===0)return es;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,f],[p,h])=>u?1:p?-1:f.length-h.length),a=Object.create(null);for(let u=0,f=-1,p=r.length;u<p;u++){const[h,y,C]=r[u];h?a[y]=[C.map(([w])=>[w,Object.create(null)]),xe]:f++;let x;try{x=t.insert(y,f,h)}catch(w){throw w===ot?new me(y):w}h||(s[f]=C.map(([w,S])=>{const V=Object.create(null);for(S-=1;S>=0;S--){const[rt,M]=x[S];V[rt]=M}return[w,V]}))}const[n,i,d]=t.buildRegExp();for(let u=0,f=s.length;u<f;u++)for(let p=0,h=s[u].length;p<h;p++){const y=(c=s[u][p])==null?void 0:c[1];if(!y)continue;const C=Object.keys(y);for(let x=0,w=C.length;x<w;x++)y[C[x]]=d[y[C[x]]]}const l=[];for(const u in i)l[u]=s[i[u]];return[n,l,a]}function at(e,t){if(e){for(const s of Object.keys(e).sort((r,a)=>a.length-r.length))if(ve(s).test(t))return[...e[s]]}}var U,z,Pt,be,se,as=(se=class{constructor(){v(this,Pt);g(this,"name","RegExpRouter");v(this,U);v(this,z);g(this,"match",Ke);m(this,U,{[j]:Object.create(null)}),m(this,z,{[j]:Object.create(null)})}add(e,t,s){var d;const r=o(this,U),a=o(this,z);if(!r||!a)throw new Error(he);r[e]||[r,a].forEach(l=>{l[e]=Object.create(null),Object.keys(l[j]).forEach(c=>{l[e][c]=[...l[j][c]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ve(t);e===j?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=at(r[c],t)||at(r[j],t)||[])}):(d=r[e])[t]||(d[t]=at(r[e],t)||at(r[j],t)||[]),Object.keys(r).forEach(c=>{(e===j||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([s,n])})}),Object.keys(a).forEach(c=>{(e===j||e===c)&&Object.keys(a[c]).forEach(u=>l.test(u)&&a[c][u].push([s,n]))});return}const i=oe(t)||[t];for(let l=0,c=i.length;l<c;l++){const u=i[l];Object.keys(a).forEach(f=>{var p;(e===j||e===f)&&((p=a[f])[u]||(p[u]=[...at(r[f],u)||at(r[j],u)||[]]),a[f][u].push([s,n-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(o(this,z)).concat(Object.keys(o(this,U))).forEach(t=>{e[t]||(e[t]=b(this,Pt,be).call(this,t))}),m(this,U,m(this,z,void 0)),ss(),e}},U=new WeakMap,z=new WeakMap,Pt=new WeakSet,be=function(e){const t=[];let s=e===j;return[o(this,U),o(this,z)].forEach(r=>{const a=r[e]?Object.keys(r[e]).map(n=>[n,r[e][n]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==j&&t.push(...Object.keys(r[j]).map(n=>[n,r[j][n]]))}),s?rs(t):null},se),W,D,re,ns=(re=class{constructor(e){g(this,"name","SmartRouter");v(this,W,[]);v(this,D,[]);m(this,W,e.routers)}add(e,t,s){if(!o(this,D))throw new Error(he);o(this,D).push([e,t,s])}match(e,t){if(!o(this,D))throw new Error("Fatal error");const s=o(this,W),r=o(this,D),a=s.length;let n=0,i;for(;n<a;n++){const d=s[n];try{for(let l=0,c=r.length;l<c;l++)d.add(...r[l]);i=d.match(e,t)}catch(l){if(l instanceof me)continue;throw l}this.match=d.match.bind(d),m(this,W,[d]),m(this,D,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(o(this,D)||o(this,W).length!==1)throw new Error("No active router has been determined yet.");return o(this,W)[0]}},W=new WeakMap,D=new WeakMap,re),bt=Object.create(null),G,R,tt,pt,E,B,K,ht,is=(ht=class{constructor(t,s,r){v(this,B);v(this,G);v(this,R);v(this,tt);v(this,pt,0);v(this,E,bt);if(m(this,R,r||Object.create(null)),m(this,G,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},m(this,G,[a])}m(this,tt,[])}insert(t,s,r){m(this,pt,++Wt(this,pt)._);let a=this;const n=Te(s),i=[];for(let d=0,l=n.length;d<l;d++){const c=n[d],u=n[d+1],f=De(c,u),p=Array.isArray(f)?f[0]:c;if(p in o(a,R)){a=o(a,R)[p],f&&i.push(f[1]);continue}o(a,R)[p]=new ht,f&&(o(a,tt).push(f),i.push(f[1])),a=o(a,R)[p]}return o(a,G).push({[t]:{handler:r,possibleKeys:i.filter((d,l,c)=>c.indexOf(d)===l),score:o(this,pt)}}),a}search(t,s){var l;const r=[];m(this,E,bt);let n=[this];const i=ne(s),d=[];for(let c=0,u=i.length;c<u;c++){const f=i[c],p=c===u-1,h=[];for(let y=0,C=n.length;y<C;y++){const x=n[y],w=o(x,R)[f];w&&(m(w,E,o(x,E)),p?(o(w,R)["*"]&&r.push(...b(this,B,K).call(this,o(w,R)["*"],t,o(x,E))),r.push(...b(this,B,K).call(this,w,t,o(x,E)))):h.push(w));for(let S=0,V=o(x,tt).length;S<V;S++){const rt=o(x,tt)[S],M=o(x,E)===bt?{}:{...o(x,E)};if(rt==="*"){const N=o(x,R)["*"];N&&(r.push(...b(this,B,K).call(this,N,t,o(x,E))),m(N,E,M),h.push(N));continue}const[Dt,Mt,vt]=rt;if(!f&&!(vt instanceof RegExp))continue;const T=o(x,R)[Dt],Ee=i.slice(c).join("/");if(vt instanceof RegExp){const N=vt.exec(Ee);if(N){if(M[Mt]=N[0],r.push(...b(this,B,K).call(this,T,t,o(x,E),M)),Object.keys(o(T,R)).length){m(T,E,M);const Bt=((l=N[0].match(/\//))==null?void 0:l.length)??0;(d[Bt]||(d[Bt]=[])).push(T)}continue}}(vt===!0||vt.test(f))&&(M[Mt]=f,p?(r.push(...b(this,B,K).call(this,T,t,M,o(x,E))),o(T,R)["*"]&&r.push(...b(this,B,K).call(this,o(T,R)["*"],t,M,o(x,E)))):(m(T,E,M),h.push(T)))}}n=h.concat(d.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},G=new WeakMap,R=new WeakMap,tt=new WeakMap,pt=new WeakMap,E=new WeakMap,B=new WeakSet,K=function(t,s,r,a){const n=[];for(let i=0,d=o(t,G).length;i<d;i++){const l=o(t,G)[i],c=l[s]||l[j],u={};if(c!==void 0&&(c.params=Object.create(null),n.push(c),r!==bt||a&&a!==bt))for(let f=0,p=c.possibleKeys.length;f<p;f++){const h=c.possibleKeys[f],y=u[c.score];c.params[h]=a!=null&&a[h]&&!y?a[h]:r[h]??(a==null?void 0:a[h]),u[c.score]=!0}}return n},ht),et,ae,os=(ae=class{constructor(){g(this,"name","TrieRouter");v(this,et);m(this,et,new is)}add(e,t,s){const r=oe(t);if(r){for(let a=0,n=r.length;a<n;a++)o(this,et).insert(e,r[a],s);return}o(this,et).insert(e,t,s)}match(e,t){return o(this,et).search(e,t)}},et=new WeakMap,ae),mt=class extends Je{constructor(e={}){super(e),this.router=e.router??new ns({routers:[new as,new os]})}},cs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Jt=(e,t=ds)=>{const s=/\.([a-zA-Z0-9]+?)$/,r=e.match(s);if(!r)return;let a=t[r[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},ls={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},ds=ls,us=(...e)=>{let t=e.filter(a=>a!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),r=[];for(const a of s)a===".."&&r.length>0&&r.at(-1)!==".."?r.pop():a!=="."&&r.push(a);return r.join("/")||"."},ye={br:".br",zstd:".zst",gzip:".gz"},fs=Object.keys(ye),ps="index.html",hs=e=>{const t=e.root??"./",s=e.path,r=e.join??us;return async(a,n)=>{var u,f,p,h;if(a.finalized)return n();let i;if(e.path)i=e.path;else try{if(i=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(i))throw new Error}catch{return await((u=e.onNotFound)==null?void 0:u.call(e,a.req.path,a)),n()}let d=r(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(i):i);e.isDir&&await e.isDir(d)&&(d=r(d,ps));const l=e.getContent;let c=await l(d,a);if(c instanceof Response)return a.newResponse(c.body,c);if(c){const y=e.mimes&&Jt(d,e.mimes)||Jt(d);if(a.header("Content-Type",y||"application/octet-stream"),e.precompressed&&(!y||cs.test(y))){const C=new Set((f=a.req.header("Accept-Encoding"))==null?void 0:f.split(",").map(x=>x.trim()));for(const x of fs){if(!C.has(x))continue;const w=await l(d+ye[x],a);if(w){c=w,a.header("Content-Encoding",x),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((p=e.onFound)==null?void 0:p.call(e,d,a)),a.body(c)}await((h=e.onNotFound)==null?void 0:h.call(e,d,a)),await n()}},ms=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let r;t&&t.namespace?r=t.namespace:r=__STATIC_CONTENT;const a=s[e]||e;if(!a)return null;const n=await r.get(a,{type:"stream"});return n||null},gs=e=>async function(s,r){return hs({...e,getContent:async n=>ms(n,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,r)},we=e=>gs(e),xs=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(n=>typeof n=="string"?n==="*"?()=>n:i=>n===i?i:null:typeof n=="function"?n:i=>n.includes(i)?i:null)(s.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(s.allowMethods);return async function(i,d){var u;function l(f,p){i.res.headers.set(f,p)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),s.credentials&&l("Access-Control-Allow-Credentials","true"),(u=s.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),i.req.method==="OPTIONS"){s.origin!=="*"&&l("Vary","Origin"),s.maxAge!=null&&l("Access-Control-Max-Age",s.maxAge.toString());const f=await a(i.req.header("origin")||"",i);f.length&&l("Access-Control-Allow-Methods",f.join(","));let p=s.allowHeaders;if(!(p!=null&&p.length)){const h=i.req.header("Access-Control-Request-Headers");h&&(p=h.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await d(),s.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};class Kt{static calculate(t){const s=t.cnt_win+t.cnt_plc,r=Math.min(1,Math.sqrt(s/500)),a=t.rate_win_ret*.3+t.rate_plc_ret*.7-80,n=10*Math.tanh(a*r/25),i=this.getGrade(n);return{score:Math.round(n*100)/100,grade:i,reliability:Math.round(r*1e3)/1e3,weightedDiff:Math.round(a*100)/100}}static getGrade(t){return t>=7?"S":t>=4?"A":t>=1?"B":t>=-3?"C":"D"}static getGradeDescription(t){return{S:"極めて優秀 - 高い収益性が期待できる",A:"優秀 - 安定した収益が見込める",B:"良好 - プラス収益の可能性が高い",C:"平均 - 標準的なパフォーマンス",D:"要改善 - 収益性が低い可能性がある"}[t]||"不明"}}class Xt{static calculate(t){const s=new Map,r=this.groupByRaceId(t);for(const[a,n]of r.entries()){const i=n.map(h=>({horse:h,nMin:Math.min(h.cnt_win,h.cnt_plc),hitRaw:.65*h.rate_win_hit+.35*h.rate_plc_hit,retRaw:.35*h.rate_win_ret+.65*h.rate_plc_ret})),d=i.map(h=>h.hitRaw),l=i.map(h=>h.retRaw),c=this.mean(d),u=this.stdDev(d,c),f=this.mean(l),p=this.stdDev(l,f);for(const{horse:h,nMin:y,hitRaw:C,retRaw:x}of i){const w=u>0?(C-c)/u:0,S=p>0?(x-f)/p:0,V=Math.sqrt(y/(y+400)),rt=.55*w+.45*S,M=Math.round(12*Math.tanh(rt)*V*10)/10,Dt=this.getGrade(M),Mt=`${a}_${h.cnt_win}_${h.cnt_plc}`;s.set(Mt,{score:M,grade:Dt,hitRaw:Math.round(C*100)/100,retRaw:Math.round(x*100)/100,shrinkage:Math.round(V*1e3)/1e3})}}return s}static groupByRaceId(t){const s=new Map;for(const r of t){const a=s.get(r.group_id)||[];a.push(r),s.set(r.group_id,a)}return s}static mean(t){return t.length===0?0:t.reduce((s,r)=>s+r,0)/t.length}static stdDev(t,s){if(t.length<=1)return 0;const r=t.reduce((a,n)=>a+Math.pow(n-s,2),0)/t.length;return Math.sqrt(r)}static getGrade(t){return t>=8?"S+":t>=5?"S":t>=2?"A":t>=-1?"B":t>=-4?"C":"D"}static getGradeDescription(t){return{"S+":"最高評価 - レース内で圧倒的な優位性",S:"極めて優秀 - レース内で明確な優位性",A:"優秀 - レース内で有力候補",B:"良好 - レース内で競争力あり",C:"平均 - レース内で標準的な位置",D:"要改善 - レース内で劣勢"}[t]||"不明"}}const gt=new mt;gt.use("/*",xs());gt.post("/rgs/calculate",async e=>{try{const t=await e.req.json();if(typeof t.cnt_win!="number"||t.cnt_win<0)return e.json({error:"cnt_win must be a positive number"},400);if(typeof t.cnt_plc!="number"||t.cnt_plc<0)return e.json({error:"cnt_plc must be a positive number"},400);if(typeof t.rate_win_ret!="number")return e.json({error:"rate_win_ret must be a number"},400);if(typeof t.rate_plc_ret!="number")return e.json({error:"rate_plc_ret must be a number"},400);const s=Kt.calculate(t);return e.json({success:!0,data:{score:s.score,grade:s.grade,reliability:s.reliability,weightedDiff:s.weightedDiff,description:Kt.getGradeDescription(s.grade)}})}catch(t){return console.error("RGS calculation error:",t),e.json({success:!1,error:"RGS calculation failed",message:t instanceof Error?t.message:"Unknown error"},500)}});gt.post("/aas/calculate",async e=>{try{const t=await e.req.json();if(!Array.isArray(t.horses)||t.horses.length===0)return e.json({error:"horses must be a non-empty array"},400);for(const a of t.horses){if(!a.group_id||typeof a.group_id!="string")return e.json({error:"group_id is required and must be a string"},400);if(typeof a.cnt_win!="number"||a.cnt_win<0)return e.json({error:"cnt_win must be a positive number"},400);if(typeof a.cnt_plc!="number"||a.cnt_plc<0)return e.json({error:"cnt_plc must be a positive number"},400);if(typeof a.rate_win_hit!="number")return e.json({error:"rate_win_hit must be a number"},400);if(typeof a.rate_plc_hit!="number")return e.json({error:"rate_plc_hit must be a number"},400);if(typeof a.rate_win_ret!="number")return e.json({error:"rate_win_ret must be a number"},400);if(typeof a.rate_plc_ret!="number")return e.json({error:"rate_plc_ret must be a number"},400)}const s=Xt.calculate(t.horses),r=Array.from(s.entries()).map(([a,n])=>({key:a,score:n.score,grade:n.grade,hitRaw:n.hitRaw,retRaw:n.retRaw,shrinkage:n.shrinkage,description:Xt.getGradeDescription(n.grade)}));return e.json({success:!0,data:{count:r.length,results:r}})}catch(t){return console.error("AAS calculation error:",t),e.json({success:!1,error:"AAS calculation failed",message:t instanceof Error?t.message:"Unknown error"},500)}});gt.post("/factor/test",async e=>{try{const t=await e.req.json();if(!Array.isArray(t.factors)||t.factors.length===0)return e.json({error:"factors must be a non-empty array"},400);if(!Array.isArray(t.testData)||t.testData.length===0)return e.json({error:"testData must be a non-empty array"},400);const s=t.factors.reduce((p,h)=>p+h.weight,0);if(Math.abs(s-100)>.01)return e.json({error:"Total weight must be 100%"},400);const r=t.testData.map(p=>{var x,w;const h=((x=t.factors.find(S=>S.name==="RGS基礎値"))==null?void 0:x.weight)||0,y=((w=t.factors.find(S=>S.name==="AAS基礎値"))==null?void 0:w.weight)||0,C=p.rgs_score*h/100+p.aas_score*y/100;return{...p,factor_score:C}}),a=new Map;for(const p of r){const h=a.get(p.race_id)||[];h.push(p),a.set(p.race_id,h)}const n=[];for(const[p,h]of a.entries())h.sort((C,x)=>x.factor_score-C.factor_score).forEach((C,x)=>{n.push({...C,predicted_rank:x+1})});let i=0,d=0,l=r.length;for(const p of n)p.predicted_rank===1&&p.actual_rank<=3&&(i++,d+=100*(4-p.actual_rank));const c=i/l*100,u=d/(l*100)*100,f=u-100;return e.json({success:!0,data:{performance:{hit_rate:Math.round(c*10)/10,recovery_rate:Math.round(u*10)/10,roi:Math.round(f*10)/10,total_bets:l,total_hits:i,total_return:d},predictions:n.slice(0,10)}})}catch(t){return console.error("Factor test error:",t),e.json({success:!1,error:"Factor test failed",message:t instanceof Error?t.message:"Unknown error"},500)}});gt.get("/health",e=>e.json({success:!0,message:"UMAYOMI API is running",version:"1.0.0",timestamp:new Date().toISOString()}));const Ce=new mt;Ce.get("/condition-settings",e=>e.html(`<!DOCTYPE html>
<html lang="ja">
<head>
    <meta charset="UTF-8">
...
</html>`));const je=new mt;je.get("/analysis",e=>e.html(`<!DOCTYPE html>
<html lang="ja">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`));const xt=new mt,Ct=[];xt.get("/factor-register",e=>e.html(`<!DOCTYPE html>
<html lang="ja">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`));const Qt=new mt,vs=Object.assign({"/src/index.tsx":Y});let ke=!1;for(const[,e]of Object.entries(vs))e&&(Qt.route("/",e),Qt.notFound(e.notFoundHandler),ke=!0);if(!ke)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Qt as default};
